	...
	<div class="nav-top">
		<div class="top">
			<div class="py-container">
				<div class="shortcut">
					<ul class="fl">
						<li class="f-item">品优购欢迎您！${user.username }</li>
						<li id="quit" class="f-item"><a href="user?cmd=quit">&nbsp&nbsp退出</a></li>
						<li id="login-reg" class="f-item">
							请<a href="login.html" target="_blank">登录</a>　
					...
					<div class="yui3-u Right shopArea">
						<div class="fr shopcar">
							<div class="show-shopcar" id="shopcar">
								<span class="car"></span>
								<a class="sui-btn btn-default btn-xlarge" href="cart.jsp" target="_blank">
									<span>我的购物车</span>
									<i class="shopnum">0</i>
								</a>
				...
				<ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="item.html" class="pic"><img src="img/like_02.png" alt="" /></a>
								<div class="like-text">
							...
							<dd>
								<a href="item.html" class="pic"><img src="img/like_01.png" alt="" /></a>
								<div class="like-text">
